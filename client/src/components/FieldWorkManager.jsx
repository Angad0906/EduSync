...
function FieldWorkManager() {
  ...
  const fetchFieldWorks = async () => {
    ...
    } catch (error) {toast.error("Error fetching field works");
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      resetForm();
      fetchFieldWorks();
    } catch (error) {toast.error(error.response?.data?.message || "Error saving field work");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this field work?")) {
      try {
        ...
        fetchFieldWorks();
      } catch (error) {toast.error("Error deleting field work");
      }
    }
  };
