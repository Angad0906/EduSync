...
function TeachingPracticeManager() {
  ...
  const fetchPractices = async () => {
    ...
    } catch (error) {setError("Error fetching teaching practices")
    }
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      resetForm()
      fetchPractices()
    } catch (error) {setError(error.response?.data?.message || "Error saving teaching practice")
    } finally {
      setLoading(false)
    }
  }
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this teaching practice?")) {
      try {
        ...
        fetchPractices()
      } catch (error) {setError("Error deleting teaching practice")
      }
    }
  }
