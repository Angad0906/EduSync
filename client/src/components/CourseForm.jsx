...
function CourseForm({ addCourse }) {
  ...
  const fetchInstructors = async () => {
    ...
    } catch (error) {toast.error("Error fetching instructors. Please try again later.");
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Remove lab time slot restrictions - labs can be scheduled at any timeawait addCourse(formData);
