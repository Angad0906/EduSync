            ...
            <div className="mb-12">
              <div className="bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 p-6">
                ...
                <div className="flex flex-wrap justify-center gap-3">
                  {[
                    "All",
                    ...new Set(teachers.map((t) => t.department || "Other")),
                  ]
                    .sort()
                    .map((dept) => (
                      <button
                        ...
                        onClick={() => {
                          ...
                          setTimeout(() => {
                            const teachersSection =
                              document.getElementById("teachers-section");
                            if (teachersSection) {
              ...
              {teachers.length > 0 ? (
                ...
                <div className="text-center py-20">
                  ...
                  <p className="text-gray-600 max-w-md mx-auto">
                    There are currently no teachers available to display. Please
                    check back later.
                  </p>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                ...
                <div className="text-center">
                  ...
                  <div className="text-3xl font-bold text-purple-600 mb-2">
                    {Math.max(
                      ...teachers.flatMap((t) => t.teachableYears || []),
                      4
                    )}
                  </div>
