...
function TeacherDashboard() {
  ...
  const fetchData = async () => {
    ...
    } catch (error) {setError("Error fetching your data. Please try again later.")
    } finally {
      setLoading(false)
    }
  }
  ...
  const handleAbsenceSubmit = async (e) => {
    ...
    } catch (error) {setError("Error reporting absence. Please try again.")
    }
  }
  ...
  const handleScheduleChangeSubmit = async (e) => {
    ...
    } catch (error) {setError("Error submitting request. Please try again.")
    }
  }
