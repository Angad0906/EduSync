...
function ScenarioSimulator() {
  ...
  const fetchScenarios = async () => {
    ...
    } catch (error) {toast.error("Error fetching scenarios")
    }
  }
  ...
  const handleCreateScenario = async (e) => {
    ...
    try {
      ...
      resetForm()
      fetchScenarios()
    } catch (error) {toast.error(error.response?.data?.message || "Error creating scenario")
    } finally {
      setLoading(false)
    }
  }
  ...
  const handleGenerateScenario = async (scenarioId) => {
    ...
    try {
      ...
      setCurrentScenario(response.data)
      fetchScenarios()
    } catch (error) {toast.error(error.response?.data?.message || "Error generating scenario")
    } finally {
      setLoading(false)
    }
  }
  ...
  const handleCloneScenario = async (scenarioId) => {
    try {
      ...
      fetchScenarios()
    } catch (error) {toast.error("Error cloning scenario")
    }
  }
