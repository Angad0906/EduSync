...
router.get("/:id", async (req, res) => {
  try {
    ...
    res.json(course)
  } catch (error) {res.status(500).json({ message: "Error fetching course", error: error.message })
  }
})
...
router.post("/", async (req, res) => {
  ...
  } catch (error) {res.status(400).json({ message: "Error creating course", error: error.message })
  }
})
...
router.put("/:id", async (req, res) => {
  try {
    ...
    res.json(course)
  } catch (error) {res.status(400).json({ message: "Error updating course", error: error.message })
  }
})
...
router.get("/stats/overview", async (req, res) => {
  ...
  } catch (error) {res.status(500).json({ message: "Error fetching course statistics", error: error.message })
  }
})
