...
router.get("/", async (req, res) => {
  try {
    ...
    res.json(timetables)
  } catch (error) {res.status(500).json({ message: "Error fetching timetables", error: error.message })
  }
})
...
router.get("/:id", async (req, res) => {
  try {
    ...
    res.json(timetable)
  } catch (error) {res.status(500).json({ message: "Error fetching timetable", error: error.message })
  }
})
...
router.get("/program/:program", async (req, res) => {
  try {
    ...
    res.json(timetables)
  } catch (error) {res.status(500).json({ message: "Error fetching program timetables", error: error.message })
  }
})
...
router.get("/stats/overview", async (req, res) => {
  ...
  } catch (error) {res.status(500).json({ message: "Error fetching timetable statistics", error: error.message })
  }
})
...
router.get("/conflicts/check", async (req, res) => {
  ...
  } catch (error) {res.status(500).json({ message: "Error checking conflicts", error: error.message })
  }
})
