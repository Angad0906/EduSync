...
router.get("/enrollment", async (req, res) => {
  ...
  } catch (error) {res.status(500).json({ message: "Error fetching enrollment analytics", error: error.message })
  }
})
...
router.get("/courses", async (req, res) => {
  ...
  } catch (error) {res.status(500).json({ message: "Error fetching course analytics", error: error.message })
  }
})
...
router.get("/schedules", async (req, res) => {
  ...
  } catch (error) {res.status(500).json({ message: "Error fetching schedule analytics", error: error.message })
  }
})
...
router.get("/faculty", async (req, res) => {
  ...
  } catch (error) {res.status(500).json({ message: "Error fetching faculty analytics", error: error.message })
  }
})
...
router.get("/resources", async (req, res) => {
  ...
  } catch (error) {res.status(500).json({ message: "Error fetching resource analytics", error: error.message })
  }
})
...
router.get("/dashboard", async (req, res) => {
  ...
  } catch (error) {res.status(500).json({ message: "Error fetching dashboard analytics", error: error.message })
  }
})
